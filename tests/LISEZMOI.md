...
| Mail Manager — saisie | le bandeau « ce que le réseau sait déjà » hors du formulaire, sections renumérotées 1 à 5, toutes avec des champs · le résumé dans l'intitulé d'une section repliée, et l'ouverture d'une section vide · « Tout déplier » · la hauteur du formulaire rempli · Entrée passe au compteur suivant |
