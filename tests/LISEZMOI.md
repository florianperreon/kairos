...
| Mail Manager — saisie | le bandeau « ce que le réseau sait déjà » hors du formulaire · deux encadrés seulement, « Mes rendez-vous » réunissant les trois anciens · le tableau unique (rendez-vous en colonnes, trois périodes en lignes, R-signature vide en « d'avance », écart sur les périodes qui ont un précédent, totaux vivants sans redessiner) · le résumé dans l'intitulé et la règle d'ouverture · « Tout déplier » · la hauteur du formulaire rempli · Entrée suit les périodes · le tableau reste un tableau sur téléphone et défile, colonne des périodes collante · la page « Mes habilitations », ses 17 champs, sa place après « Mes objectifs » et sa mise en lecture sur une semaine passée |
| Google Agenda | un lien par séance à venir dans toutes les listes · horaires en heure de Paris, lieu (adresse du site ou lien visio), fiche et mot de passe visio dans la description · sur plusieurs jours, un événement par jour (jours déjà passés exclus, journée entière sans horaire) · rien sur une séance passée · les liens par jour tiennent sur téléphone |
